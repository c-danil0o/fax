...
def list_exam():
    ...
    for ex in exams.keys():
        print('{0:<20s}{1:<20s}{2:<20s}{3:<20s}{4:<20s}{5:<20s}'.format(ex, exams[ex]['predmet'], exams[ex]['ime'], exams[ex]['prezime'], str(exams[ex]['datum']), str(exams[ex]['broj_bodova'])))
